...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entry.audio'
        db.add_column(u'zinnia_entry', 'audio',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding unique constraint on 'Entry', fields ['slug']
        db.create_unique(u'zinnia_entry', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Entry', fields ['slug']
        db.delete_unique(u'zinnia_entry', ['slug'])

        # Deleting field 'Entry.audio'
        db.delete_column(u'zinnia_entry', 'audio')
    ...
    models = {
        ...
        'zinnia.entry': {
            ...
            'audio': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
